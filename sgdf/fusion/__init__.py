...
class BaseFusion(object):
    def set_image(self, target_ndarray):
        """
    ...
    def update_blend(self, source_ndarray, mask_ndarray, displacement):
        ...
        and a displacement (used to translate mask coordinates to canvas (target) coordinates).
        This update should replace the currently active blend, if one exists.
